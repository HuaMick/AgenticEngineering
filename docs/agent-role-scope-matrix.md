...
| **planner-agent-exam** | Create agent evaluation exams | Target agent type, completed tasks, agent guidelines | Select tasks and create exam modules for teacher-agent review of agent proposals |
