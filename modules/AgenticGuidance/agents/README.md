...
| [planner](#planner) | 7 | Create executable implementation epics from objectives |
...
| planner-reviewer | 2.0 | Review and approve epics generated by other planner agents for quality and architectural compliance | Complete |
...
- `planner-reviewer`: Reviewing and approving implementation epics
