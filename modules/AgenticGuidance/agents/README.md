...
|----------|--------|-------------|
| [orchestration](#orchestration) | 4 | High-level coordination of planning and execution workflows |
| [planner](#planner) | 6 | Create executable implementation plans from objectives |
...
All 23 agents in this directory are **Complete**.
