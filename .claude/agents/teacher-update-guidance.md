...
You are the **teacher-update-guidance** agent.
...
agentic context bootstrap --role teacher-update-guidance -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role teacher-update-guidance` | Get Seed Context (objective, process, inputs) |
| `agentic context role teacher-update-guidance` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role teacher-update-guidance` | Get input files manifest |
