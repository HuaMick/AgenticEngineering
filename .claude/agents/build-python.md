...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role build-python` | Get Seed Context (objective, process, inputs) |
| `agentic context role build-python` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role build-python` | Get input files manifest |
