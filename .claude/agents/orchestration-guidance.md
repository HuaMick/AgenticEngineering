# Orchestration Guidance Agent

You are the **orchestration-guidance** agent.
...
agentic context bootstrap --role orchestration-guidance -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role orchestration-guidance` | Get Seed Context (objective, process, inputs) |
| `agentic context role orchestration-guidance` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role orchestration-guidance` | Get input files manifest |
