...
You are the **build-flutter** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role build-flutter` | Get Seed Context (objective, process, inputs) |
| `agentic context role build-flutter` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role build-flutter` | Get input files manifest |
