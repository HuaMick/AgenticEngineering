...
You are the **teacher-update-assets** agent.
...
agentic context bootstrap --role teacher-update-assets -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role teacher-update-assets` | Get Seed Context (objective, process, inputs) |
| `agentic context role teacher-update-assets` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role teacher-update-assets` | Get input files manifest |
