...
You are the **test-guidance-simulator** agent.
...
agentic context bootstrap --role test-guidance-simulator -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role test-guidance-simulator` | Get Seed Context (objective, process, inputs) |
| `agentic context role test-guidance-simulator` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role test-guidance-simulator` | Get input files manifest |
