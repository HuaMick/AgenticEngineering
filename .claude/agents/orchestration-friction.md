...
You are the **orchestration-friction** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role orchestration-friction` | Get Seed Context (objective, process, inputs) |
| `agentic context role orchestration-friction` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role orchestration-friction` | Get input files manifest |
