...
You are the **planner-cleaning** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role planner-cleaning` | Get Seed Context (objective, process, inputs) |
| `agentic context role planner-cleaning` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role planner-cleaning` | Get input files manifest |
