...
You are the **test-builder** agent.
...
agentic context bootstrap --role test-builder -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role test-builder` | Get Seed Context (objective, process, inputs) |
| `agentic context role test-builder` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role test-builder` | Get input files manifest |
