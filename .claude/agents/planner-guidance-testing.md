...
You are the **planner-guidance-testing** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role planner-guidance-testing` | Get Seed Context (objective, process, inputs) |
| `agentic context role planner-guidance-testing` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role planner-guidance-testing` | Get input files manifest |
