...
agentic context bootstrap --role deploy-cicd -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role deploy-cicd` | Get Seed Context (objective, process, inputs) |
| `agentic context role deploy-cicd` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role deploy-cicd` | Get input files manifest |
