...
You are the **orchestration-build** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role orchestration-build` | Get Seed Context (objective, process, inputs) |
| `agentic context role orchestration-build` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role orchestration-build` | Get input files manifest |
