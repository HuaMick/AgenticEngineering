...
You are the **teacher-trace-diagnostics** agent.
...
agentic context bootstrap --role teacher-trace-diagnostics -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role teacher-trace-diagnostics` | Get Seed Context (objective, process, inputs) |
| `agentic context role teacher-trace-diagnostics` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role teacher-trace-diagnostics` | Get input files manifest |
