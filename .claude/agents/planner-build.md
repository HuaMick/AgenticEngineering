...
You are the **planner-build** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role planner-build` | Get Seed Context (objective, process, inputs) |
| `agentic context role planner-build` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role planner-build` | Get input files manifest |
