...
You are the **orchestration-executor** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role orchestration-executor` | Get Seed Context (objective, process, inputs) |
| `agentic context role orchestration-executor` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role orchestration-executor` | Get input files manifest |
