...
You are the **planner-guidance** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role planner-guidance` | Get Seed Context (objective, process, inputs) |
| `agentic context role planner-guidance` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role planner-guidance` | Get input files manifest |
