...
You are the **test-service** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role test-service` | Get Seed Context (objective, process, inputs) |
| `agentic context role test-service` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role test-service` | Get input files manifest |
