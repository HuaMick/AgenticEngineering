...
You are the **orchestration-planning** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role orchestration-planning` | Get Seed Context (objective, process, inputs) |
| `agentic context role orchestration-planning` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role orchestration-planning` | Get input files manifest |
