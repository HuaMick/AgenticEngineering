...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role test-audit` | Get Seed Context (objective, process, inputs) |
| `agentic context role test-audit` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role test-audit` | Get input files manifest |
