...
You are the **test-user-simulator** agent.
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role test-user-simulator` | Get Seed Context (objective, process, inputs) |
| `agentic context role test-user-simulator` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role test-user-simulator` | Get input files manifest |
