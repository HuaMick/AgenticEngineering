...
agentic context bootstrap --role test-runner -j
...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role test-runner` | Get Seed Context (objective, process, inputs) |
| `agentic context role test-runner` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role test-runner` | Get input files manifest |
