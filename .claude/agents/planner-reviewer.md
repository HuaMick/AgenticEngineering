...
| Command | Purpose |
|---------|---------|
| `agentic context bootstrap --role planner-reviewer` | Get Seed Context (objective, process, inputs) |
| `agentic context role planner-reviewer` | Get role-specific process/guidelines |
| `agentic context task` | Get active task from current plan |
| `agentic context inputs --role planner-reviewer` | Get input files manifest |
